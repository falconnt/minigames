...
- **Badges & streak** — verdien badges (eerste potje, alle games gespeeld, records, game-prestaties) met een melding bij het verdienen; te bekijken op de 🏆-pagina. Speel meerdere dagen op rij voor een 🔥-streak op het startscherm. Bij het opstarten (en met een knop in Instellingen) worden gemiste badges automatisch hersteld: prestaties worden afgeleid uit je bestaande highscores, zodat badges ook kloppen als je een game al speelde vóórdat die badge bestond.
